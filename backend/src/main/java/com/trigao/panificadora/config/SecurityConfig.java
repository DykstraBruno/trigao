...
import com.trigao.panificadora.security.JwtAuthenticationFilter;
import com.trigao.panificadora.security.UserDetailsServiceImpl;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                // reviews leitura publica
                .antMatchers(HttpMethod.GET, "/api/products/*/reviews", "/api/products/*/reviews/summary").permitAll()
                // SEO
